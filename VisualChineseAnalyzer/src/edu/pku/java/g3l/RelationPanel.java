...
public class RelationPanel extends JPanel implements ActionListener			//关系提示栏
{
	...
	{		
		...
		panEast.setLayout(new GridLayout());
	...
	public void actionPerformed(ActionEvent e)								//检测按钮点击
	{
		if (e.getSource() == btnSet)										//设置按钮
		{
			...
			{
				Operation operation = new Operation("Set Node Relation: " + node.getWord(), document.getForest());
		...
		{
			Operation operation = new Operation("Delelte Node Relation: " + node.getWord(), document.getForest());
